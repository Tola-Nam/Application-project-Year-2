<template>
  <div class="container mx-auto p-4 max-w-7xl min-h-screen">
    <!-- Header Section -->
    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden">
            ...
            <tr
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <div class="flex items-center">
                  ...
                  <div class="max-w-[200px]">
                    <div
                      class="text-sm font-medium text-gray-900 truncate overflow-hidden whitespace-nowrap">
                      {{ product.productName }}
                    </div>
                  </div>
                </div>
              ...
              <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                <div class="flex items-center space-x-2">
                  ...
                  <button
                    @click="openModal(product.pro_id)"
      ...
      <div class="lg:hidden">
        <div
          v-for="product in filteredProducts"
          :key="product.pr_id"
          class="border-b border-gray-200 p-4 align-middle">
  ...
  <div class="p-6">
    <div
      ...
      <div
        class="bg-white rounded-lg shadow-xl p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto relative space-y-6">
        <!-- Close Button -->
        <button
...
export default {
  ...
  methods: {
    ...
    toggleSelectAll() {
      if (this.selectAll) {
        this.selectedProducts = this.filteredProducts.map((p) => p.pro_id);
      } else {
    ...
    async deleteProduct(pro_id) {
      // alert(pro_id);
      if (confirm(`Are you sure do you want to deleted this product?`)) {
        try {
          const response = await fetch(
            `http://localhost/ApplicationBackend/api/middleware/deleted_api.php?pro_id=${pro_id}`,
            {
              method: "DELETE",
              headers: {
    ...
    async updateItem() {
      ...
      try {
        const response = await fetch(
          "http://localhost/ApplicationBackend/api/middleware/updateApi.php",
          {
            method: "POST",
            body: formData,
          }
