...
const sidebarItems = ref([
  { name: 'Dashboard', icon: '📊', active: true, notification: false },
  { name: 'Products', icon: '📦', active: false, notification: false },
  { name: 'Conversation', icon: '💬', active: false, notification: false },
  { name: 'Analytics', icon: '📈', active: false, notification: true },
  { name: 'Campaigns', icon: '📢', active: false, notification: true },
  { name: 'Audience', icon: '👥', active: false, notification: false },
  { name: 'Statistics', icon: '📊', active: false, notification: false }
])
